                    ...
                    <c:if test="<%=(order.getStatus() == 0)%>">
                        <form action="${pageContext.request.contextPath}/verifySign" method="post">
                            ...
                            <div class="form-group mt-3">
                                <label for="hash">Nội dung ký</label>
                                <textarea class="form-control" cols="20" id="hash" name="hash" rows="2" readOnly><%= hash %></textarea>
                            </div>
                            <div class="form-group mt-3">
                                <label for="sign">chữ ký</label>
                                <textarea class="form-control" cols="20" id="sign" name="sign" rows="2"></textarea>
                            </div>
